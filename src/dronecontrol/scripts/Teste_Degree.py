...
#para reduzir as duas em uma so teriamos que colocar o angulo sempre como entrada, colocando uma condicional para que ele saiba se
#e para gira ou nao
...
def abs_rotation (theta):
    ...
    while not abs(Yaw.orientation.y - goal_pose.pose.orientation.y) < SECURE:
